...
export default function ItemsUpdateForm(props) {
  const {
    id: idProp,
    items: itemsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = itemsRecord
      ? { ...initialValues, ...itemsRecord }
      : initialValues;
  ...
  const [itemsRecord, setItemsRecord] = React.useState(itemsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getItems.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getItems
        : itemsModelProp;
    ...
    queryData();
  }, [idProp, itemsModelProp]);
  React.useEffect(resetStateValues, [itemsRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateItems.replaceAll("__typename", ""),
            variables: {
              input: {
                id: itemsRecord.id,
                ...modelFields,
      ...
      {...getOverrideProps(overrides, "ItemsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || itemsModelProp)}
